...
// PrepareReq ...
func (a *ApplicationOfCreateAzureDisk) PrepareReq() error {
	return nil
}

// GenerateApplicationContent 获取预处理过的数据，以interface格式
func (a *ApplicationOfCreateAzureDisk) GenerateApplicationContent() interface{} {
	// 需要将Vendor也存储进去
	return &struct {
		*csdisk.AzureDiskCreateReq `json:",inline"`
		Vendor                     enumor.Vendor `json:"vendor"`
	}{
		AzureDiskCreateReq: a.req,
		Vendor:             a.Vendor(),
	}
}
...
func (a *ApplicationOfCreateAzureDisk) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
