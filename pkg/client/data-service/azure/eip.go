...
func (rc *restClient) BatchCreateEip(ctx context.Context,
	h http.Header,
	request *dataproto.EipExtBatchCreateReq[dataproto.AzureEipExtensionCreateReq],
...
func (rc *restClient) RetrieveEip(
	...
	h http.Header,
	eipID string,
) (*dataproto.EipExtResult[dataproto.AzureEipExtensionResult], error) {
	resp := new(dataproto.EipExtRetrieveResp[dataproto.AzureEipExtensionResult])
...
) (*dataproto.EipExtListResult[dataproto.AzureEipExtensionResult], error) {
	resp := new(dataproto.EipExtListResp[dataproto.AzureEipExtensionResult])
...
func (rc *restClient) BatchUpdateEip(
	ctx context.Context,
	h http.Header,
	request *dataproto.EipExtBatchUpdateReq[dataproto.AzureEipExtensionUpdateReq],
) (interface{}, error) {
