...
func (a *RootAccountClient) Create(kt *kit.Kit,
	request *dataproto.RootAccountCreateReq[dataproto.AzureRootAccountExtensionCreateReq]) (
	*core.CreateResult, error,
) {

	return common.Request[dataproto.RootAccountCreateReq[dataproto.AzureRootAccountExtensionCreateReq], core.CreateResult](
...
func (a *RootAccountClient) Get(kt *kit.Kit, accountID string) (
	*dataproto.RootAccountGetResult[protocore.AzureRootAccountExtension], error,
) {

	return common.Request[common.Empty, dataproto.RootAccountGetResult[protocore.AzureRootAccountExtension]](
		a.client, rest.GET, kt, nil, "/root_accounts/%s", accountID)
}

// Update ...
func (a *RootAccountClient) Update(kt *kit.Kit, accountID string,
	request *dataproto.RootAccountUpdateReq[dataproto.AzureRootAccountExtensionUpdateReq]) (
	interface{}, error,
) {

	return common.Request[dataproto.RootAccountUpdateReq[dataproto.AzureRootAccountExtensionUpdateReq], interface{}](
