...
) ([]*datarelproto.DiskExtWithCvmID[dataproto.HuaWeiDiskExtensionResult], error) {
	resp := new(datarelproto.DiskCvmRelWithDiskExtListResp[dataproto.HuaWeiDiskExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
