...
func (rc *restClient) BatchCreateEip(ctx context.Context,
	h http.Header,
	request *dataproto.EipExtBatchCreateReq[dataproto.TCloudEipExtensionCreateReq],
...
func (rc *restClient) RetrieveEip(
	...
	h http.Header,
	eipID string,
) (*dataproto.EipExtResult[dataproto.TCloudEipExtensionResult], error) {
	resp := new(dataproto.EipExtRetrieveResp[dataproto.TCloudEipExtensionResult])
...
) (*dataproto.EipExtListResult[dataproto.TCloudEipExtensionResult], error) {
	resp := new(dataproto.EipExtListResp[dataproto.TCloudEipExtensionResult])
...
func (rc *restClient) BatchUpdateEip(
	ctx context.Context,
	h http.Header,
	request *dataproto.EipExtBatchUpdateReq[dataproto.TCloudEipExtensionUpdateReq],
) (interface{}, error) {
