...
// BatchDelete vpc cvm rels.
func (svc *vpcCvmRelSvc) BatchDelete(cts *rest.Contexts) (interface{}, error) {
	...
	_, err = svc.dao.Txn().AutoTxn(cts.Kit, func(txn *sqlx.Tx, opt *orm.TxnOption) (interface{}, error) {
		if err := svc.dao.VpcCvmRel().DeleteWithTx(cts.Kit, txn, tools.ContainersExpression("id", delIDs)); err != nil {
			return nil, err
		}
	...
	if err != nil {
		logs.Errorf("delete vpc cvm rels failed, err: %v, rid: %s", err, cts.Kit.Rid)
		return nil, err
	}
