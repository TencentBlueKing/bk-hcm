...
func (v *NetworkInterfaceClient) BatchCreate(ctx context.Context, h http.Header,
	req *datacloudniproto.NetworkInterfaceBatchCreateReq[datacloudniproto.GcpNICreateExt]) (
...
// BatchUpdate gcp network interface.
func (v *NetworkInterfaceClient) BatchUpdate(ctx context.Context, h http.Header,
	req *datacloudniproto.NetworkInterfaceBatchUpdateReq[datacloudniproto.GcpNICreateExt]) error {
...
func (v *NetworkInterfaceClient) Get(ctx context.Context, h http.Header, id string) (
	*coreni.NetworkInterface[coreni.GcpNIExtension], error) {

	resp := new(datacloudniproto.NetworkInterfaceGetResp[coreni.GcpNIExtension])
...
func (v *NetworkInterfaceClient) ListNetworkInterfaceExt(ctx context.Context, h http.Header, req *core.ListReq) (
	*datacloudniproto.NetworkInterfaceExtListResult[coreni.GcpNIExtension], error) {

	resp := new(datacloudniproto.NetworkInterfaceExtListResp[coreni.GcpNIExtension])
