...
) ([]*datarelproto.DiskExtWithCvmID[dataproto.AzureDiskExtensionResult], error) {
	resp := new(datarelproto.DiskCvmRelWithDiskExtListResp[dataproto.AzureDiskExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
