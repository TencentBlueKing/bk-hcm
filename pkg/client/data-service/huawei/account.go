...
func (a *AccountClient) Create(ctx context.Context, h http.Header,
	request *protocloud.AccountCreateReq[protocloud.HuaWeiAccountExtensionCreateReq]) (
...
func (a *AccountClient) Update(ctx context.Context, h http.Header, accountID string,
	request *protocloud.AccountUpdateReq[protocloud.HuaWeiAccountExtensionUpdateReq]) (
	interface{}, error,
) {
...
func (a *AccountClient) Get(ctx context.Context, h http.Header, accountID string) (
	*protocloud.AccountGetResult[protocore.HuaWeiAccountExtension], error,
	...
	resp := new(protocloud.AccountGetResp[protocore.HuaWeiAccountExtension])
