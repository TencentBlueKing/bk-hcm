  ...
  setup() {
    ...
    const handleSubmit = async () => {
      try {
        ...
        if ([null, false].includes(formItemRmailRef.value.emailCodeVerfiyResult)) return;
        const { data } = await billStore.create_main_account({
          ...formModel,
          email: `${formModel.email}${suffixText}`,
          business_type: formModel.site,
          verify_code: formItemRmailRef.value.dialogForm.value.code,
          extension: {
                        ...
                        name: [
                          {
                            ...
                            validator: (val: string) => {
                              ...
                              // console.log(formItemRmailRef.value);

                              formItemRmailRef.value.changeNameValid(isValid);
                              return isValid;
                            },
                          },
                        ],
