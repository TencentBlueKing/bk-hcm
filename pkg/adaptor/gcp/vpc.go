...
// Poll ...
func (h *createVpcPollingHandler) Poll(client *Gcp, kt *kit.Kit, opIds []*string) ([]*compute.Operation, error) {
	if len(opIds) == 0 {
	...
	opList, err := computeClient.GlobalOperations.List(client.CloudProjectID()).Context(kt.Ctx).
