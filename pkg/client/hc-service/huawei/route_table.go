...
// RouteTableClient is hc service huawei route table api client.
...
func (r *RouteTableClient) SyncRouteTable(ctx context.Context, h http.Header, req *sync.HuaWeiSyncReq) error {
