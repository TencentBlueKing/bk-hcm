...
const (
	// ConfirmListURL 预测确认通知跳转链接
	ConfirmListURL = "%s/#/business/resource-plan?bizs=%d"

	// ConfirmEmailTitleTemplate 预测确认通知邮件标题模板
	ConfirmEmailTitleTemplate = "HCM-%s业务-资源预测提前14-16周确认通知-%s"

	// ConfirmEmailTableTemplate 预测确认通知邮件表格行模板
	ConfirmEmailTableTemplate = `<tr style="height: 42px">
                  <td
                    style="
                      padding: 0 16px;
	...
	// ConfirmEmailContentTemplate 预测确认通知邮件内容模板
	ConfirmEmailContentTemplate = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
      ...
      >
        ...
        <div style="margin: 0; padding: 0; width: 100%%; line-height: 22px">
          ...
          <div style="display: inline-block; margin-right: 64px">
            ...
            ></span>
            <span style="vertical-align: middle">
              <span style="font-size: 12px; color: #4d4f56">通知月份：</span>
              <span style="font-size: 12px; color: #313238; font-weight: 700">%s</span>
            </span>
          </div>
          <div style="display: inline-block; margin-right: 64px">
            ...
            ></span>
            <span style="vertical-align: middle">
              <span style="font-size: 12px; color: #4d4f56">CPU核数：</span>
              <span style="font-size: 12px; color: #313238; font-weight: 700">%d核</span>
            </span>
          </div>
          <div style="display: inline-block">
            ...
            ></span>
            <span style="vertical-align: middle">
              <span style="font-size: 12px; color: #4d4f56">预测链接：</span>
              <a
                href="%s"
                style="font-size: 12px; color: #3a84ff; text-decoration: none"
              >
                点击链接立即确认
              </a>
            </span>
