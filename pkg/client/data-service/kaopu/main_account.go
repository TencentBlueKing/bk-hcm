...
func (a *MainAccountClient) Create(kt *kit.Kit,
	...
	*core.CreateResult, error,
	...
	return common.Request[dataproto.MainAccountCreateReq[dataproto.KaopuMainAccountExtensionCreateReq], core.CreateResult](
...
func (a *MainAccountClient) Get(kt *kit.Kit, accountID string) (
	*dataproto.MainAccountGetResult[protocore.KaopuMainAccountExtension], error,
	...
	return common.Request[common.Empty, dataproto.MainAccountGetResult[protocore.KaopuMainAccountExtension]](
