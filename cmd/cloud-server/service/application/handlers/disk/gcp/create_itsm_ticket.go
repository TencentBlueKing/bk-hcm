...
// CreateITSMTicket ...
func (a *ApplicationOfCreateGcpDisk) CreateITSMTicket(serviceID int64, callbackUrl string) (string, error) {
	// 渲染ITSM表单内容
...
func (a *ApplicationOfCreateGcpDisk) renderITSMForm() (string, error) {
	req := a.req
