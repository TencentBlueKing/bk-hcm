...
POST /api/v1/cloud/bizs/{bk_biz_id}/accounts/list
    ...
    "details": [
      {
        ...
        "usage_biz_ids": [310],
        "email": "test-email",
        "cloud_created_at": "2022-12-26T07:42:15Z",
        "sync_status": "sync_success",
        "sync_failed_reason": "",
        "sub_account_count": 10,
        "account_secret_count": 10,
        "creator": "Jim",
        "reviser": "Jim",
...
| security_managers    | string array | 账号安全管理者                                                                       |
...
| memo                 | string       | 备注                                                                            |
| bk_biz_id            | int64        | 管理业务id                                                                        |
| usage_biz_ids        | int64 array  | 使用业务id列表                                                                      |
| email                | string       | 邮箱                                                                            |
| cloud_created_at     | string       | 云上创建时间                                                                        |
| sync_status          | string       | 资源同步状态, 枚举值：sync_success(同步成功)、 sync_failed(同步失败)、 not_sync(未同步)、syncing(同步中) |
| sync_failed_reason   | string       | 资源同步失败原因                                                         |
| sub_account_count    | int64        | 三级账号数                                                                         |
| account_secret_count | int64        | 密钥数                                                                           |
| creator              | string       | 创建者                                                                           |
| reviser              | string       | 更新者                                                                           |
