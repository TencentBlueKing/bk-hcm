...
func (b *BillClient) ListBillItem(kt *kit.Kit, req *core.ListReq) (*billproto.ZenlayerBillItemListResult, error) {

	return common.Request[core.ListReq, billproto.ZenlayerBillItemListResult](
