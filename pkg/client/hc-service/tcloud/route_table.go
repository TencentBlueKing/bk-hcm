...
// RouteTableClient is hc service tencent cloud route table api client.
...
func (r *RouteTableClient) SyncRouteTable(ctx context.Context, h http.Header, req *sync.TCloudSyncReq) error {
