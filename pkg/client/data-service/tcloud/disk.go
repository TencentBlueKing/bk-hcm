...
func (rc *restClient) BatchCreateDisk(ctx context.Context,
	h http.Header,
	request *dataproto.DiskExtBatchCreateReq[coredisk.TCloudExtension],
...
func (rc *restClient) RetrieveDisk(
	...
	resp := new(dataproto.GetResp[coredisk.TCloudExtension])
...
) (*dataproto.ListExtResult[coredisk.TCloudExtension], error) {
	resp := new(dataproto.ListExtResp[coredisk.TCloudExtension])
...
func (rc *restClient) BatchUpdateDisk(
	ctx context.Context,
	h http.Header,
	request *dataproto.DiskExtBatchUpdateReq[coredisk.TCloudExtension],
) (interface{}, error) {
