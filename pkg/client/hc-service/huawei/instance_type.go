...
// List ...
func (c *InstanceTypeClient) List(kt *kit.Kit, request *instancetype.HuaWeiInstanceTypeListReq) (
	[]*instancetype.HuaWeiInstanceTypeResp, error) {

	resp := new(instancetype.HuaWeiInstanceTypeListResp)
