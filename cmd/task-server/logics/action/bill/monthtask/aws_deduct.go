...
func (a AwsDeductMonthTask) Pull(kt *kit.Kit, opt *MonthTaskActionOption, index uint64) (itemList []bill.RawBillItem,
	...
	billItemReq := &bill.BillItemListReq{
		...
		ListReq: &core.ListReq{
			...
			Page: &core.BasePage{Start: uint32(index), Limit: uint(a.GetBatchSize(kt))},
		},
	}
...
func (a AwsDeductMonthTask) Split(kt *kit.Kit, opt *MonthTaskActionOption,
	...
	commonItems, err := a.splitProductCodeReverse(kt, opt, mainAccountMap, rawItemList,
...
func (a AwsDeductMonthTask) splitProductCodeReverse(kt *kit.Kit, opt *MonthTaskActionOption,
	mainAccountMap map[string]*protocore.BaseMainAccount, rawItemList []*bill.RawBillItem, hcProductCode string) (
	...
	summaryList, err := a.listSummaryMainByAccountIDs(kt, opt, mainAccountMap)
	if err != nil {
	...
	for _, summary := range summaryList {
		...
		reverseBillItem := convSummaryToProductCodeReverse(hcProductCode, mainAccount, summary, reverseCost,
			reverseExtJson)
...
// 获取二级账号汇总列表
func (a AwsDeductMonthTask) listSummaryMainByAccountIDs(kt *kit.Kit, opt *MonthTaskActionOption,
	mainAccountMap map[string]*protocore.BaseMainAccount) ([]*bill.BillSummaryMain, error) {
