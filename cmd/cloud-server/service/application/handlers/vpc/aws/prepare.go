...
func (a *ApplicationOfCreateAwsVpc) PrepareReq() error {
...
func (a *ApplicationOfCreateAwsVpc) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
