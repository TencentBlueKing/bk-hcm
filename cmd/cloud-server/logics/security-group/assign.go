...
func ListSecurityGroupRulesByCloudTargetSGID(kt *kit.Kit, cli *dataservice.Client, vendor enumor.Vendor, cloudID string) (map[string][]string, error) {
...
func listTCloudSecurityGroupRulesByCloudTargetSGID(kt *kit.Kit, cli *dataservice.Client, sgID string) (map[string][]string, error) {
...
// 返回 map[安全组ID]安全组规则ID列表
func listAwsSecurityGroupRulesByCloudTargetSGID(kt *kit.Kit, cli *dataservice.Client, sgID string) (map[string][]string, error) {
...
// 返回 map[安全组ID]安全组规则ID列表
func listAzureSecurityGroupRulesByCloudTargetSGID(kt *kit.Kit, cli *dataservice.Client, sgID string) (map[string][]string, error) {
...
// 返回 map[安全组ID]安全组规则ID列表
func listHuaweiSecurityGroupRulesByCloudTargetSGID(kt *kit.Kit, cli *dataservice.Client, sgID string) (map[string][]string, error) {
