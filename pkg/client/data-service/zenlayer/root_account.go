...
// RootAccountClient defines the client for RootAccount service
...
func (a *RootAccountClient) Get(kt *kit.Kit, accountID string) (
	*dataproto.RootAccountGetResult[protocore.ZenlayerRootAccountExtension], error,
) {

	return common.Request[common.Empty, dataproto.RootAccountGetResult[protocore.ZenlayerRootAccountExtension]](
		a.client, rest.GET, kt, nil, "/root_accounts/%s", accountID)
}

// Update ...
func (a *RootAccountClient) Update(kt *kit.Kit, accountID string,
	request *dataproto.RootAccountUpdateReq[dataproto.ZenlayerRootAccountExtensionUpdateReq]) (
	interface{}, error,
) {

	return common.Request[dataproto.RootAccountUpdateReq[dataproto.ZenlayerRootAccountExtensionUpdateReq], interface{}](
