...
// // AccountBillAdjustmentPreColumns defines account_bill_adjustment_item's columns.
// var AccountBillAdjustmentPreColumns = utils.MergeColumns(nil, AccountBillAdjustmentPreColumnDescriptor)

// // AccountBillSummaryDailyColumnDescriptor is account_bill_summary_daily's column descriptors.
// var AccountBillAdjustmentPreColumnDescriptor = utils.ColumnDescriptors{
...
// // AccountBillAdjustmentPre 存储未确定的手动调账明细
// type AccountBillAdjustmentPre struct {
// 	// ID 自增ID
...
// // TableName 返回账单明细表名
// func (abs *AccountBillAdjustmentPre) TableName() table.Name {
// 	return table.AccountBillAdjustmentPreTable
// }

// // InsertValidate validate account bill item on insert
// func (abs *AccountBillAdjustmentPre) InsertValidate() error {
...
// func (abs *AccountBillAdjustmentPre) UpdateValidate() error {
// 	if err := validator.Validate.Struct(abs); err != nil {
// 		return err
// 	}
// 	if len(abs.ID) == 0 {
