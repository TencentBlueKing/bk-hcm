...
// PrepareReq ...
func (a *ApplicationOfCreateAwsDisk) PrepareReq() error {
	return nil
}
...
func (a *ApplicationOfCreateAwsDisk) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
