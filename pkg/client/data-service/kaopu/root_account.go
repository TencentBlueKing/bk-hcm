...
func (a *RootAccountClient) Create(kt *kit.Kit,
	request *dataproto.RootAccountCreateReq[dataproto.KaopuRootAccountExtensionCreateReq]) (
	*core.CreateResult, error,
) {

	return common.Request[dataproto.RootAccountCreateReq[dataproto.KaopuRootAccountExtensionCreateReq], core.CreateResult](
