...
// SyncSG ...
func SyncSG(kt *kit.Kit, cliSet *client.ClientSet, accountID string, regions []string,
	...
	for _, region := range regions {
		...
		if err := cliSet.HCService().Aws.SecurityGroup.SyncSecurityGroup(kt.Ctx, kt.Header(), req); err != nil {
