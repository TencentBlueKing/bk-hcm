...
- 该接口提供版本：v9.9.9+。
- 该接口所需权限：业务访问。
- 该接口功能描述：查询负载均衡检索匹配到的拓扑总结信息。

### URL

POST /api/v1/cloud/bizs/{bk_biz_id}/vendors/{vendor}/load_balancers/topo/summary
...
```json
{
  ...
  "data": {
    ...
    "rule_count": 100,
    "target_count": 100,
    "lb_ids": ["0000001", "0000002"],
    "target_group_ids": ["0000001", "0000002"]
  }
}
```
...
| lb_ids           | string array | 负载均衡id列表 |
| target_group_ids | string array | 目标组id列表  |
