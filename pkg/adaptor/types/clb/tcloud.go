...
type TCloudUpdateOption struct {
	Region string `json:"region" validate:"required"`
	// 负载均衡的唯一ID
	LoadBalancerId string `json:"LoadBalancerId" validate:"required"`

	// 负载均衡实例名称
	LoadBalancerName *string `json:"LoadBalancerName"`

	// 设置负载均衡跨地域绑定1.0的后端服务信息
	TargetRegionInfo *tclb.TargetRegionInfo `json:"TargetRegionInfo" `
	...
	ModifyClassicDomain *bool `json:"ModifyClassicDomain" `
}
