...
- 该接口提供版本：v9.9.9。
- 该接口所需权限：自研云管理-交付分析。
- 该接口功能描述：查询单据平均耗时的对比统计，按月、业务聚合单据和子订单数据。

### URL

POST /api/v1/woa/task/apply/analysis/average_time_consumption/compare
    ...
    "current": [
      {
        ...
        "year_month": "2025-10",
        "done_orders": 0,
        "avg_duration_hours": 0.01
      },
      {
        "bk_biz_id": 100269,
        "year_month": "2025-10",
        "done_orders": 3,
        "avg_duration_hours": 0.12
      }
    ],
    "compare": [
      {
