...
func (cli *SubAccountClient) Get(kt *kit.Kit, id string) (
	*coresubaccount.SubAccount[coresubaccount.GcpExtension], error) {
	...
	resp := &struct {
		...
		Data          *coresubaccount.SubAccount[coresubaccount.GcpExtension] `json:"data"`
	}{}
...
func (cli *SubAccountClient) ListExt(kt *kit.Kit, request *core.ListReq) (
	*dssubaccount.ListExtResult[coresubaccount.GcpExtension], error) {

	resp := &struct {
		rest.BaseResp `json:",inline"`
		Data          *dssubaccount.ListExtResult[coresubaccount.GcpExtension] `json:"data"`
	}{}
