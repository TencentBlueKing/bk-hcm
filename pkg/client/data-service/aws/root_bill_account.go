...
func (v *RootAccountBillConfigClient) BatchCreate(ctx context.Context, h http.Header,
	req *protobill.RootAccountBillConfigBatchCreateReq[billcore.AwsBillConfigExtension]) (
...
func (v *RootAccountBillConfigClient) BatchUpdate(ctx context.Context, h http.Header,
	req *protobill.RootAccountBillConfigBatchUpdateReq[billcore.AwsBillConfigExtension]) error {
...
func (v *RootAccountBillConfigClient) List(ctx context.Context, h http.Header, req *core.ListReq) (
	*protobill.RootAccountBillConfigExtListResult[billcore.AwsBillConfigExtension], error) {

	resp := new(protobill.RootAccountBillConfigExtListResp[billcore.AwsBillConfigExtension])
