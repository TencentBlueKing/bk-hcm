...
// Get tencent cloud subnet.
func (v *SubnetClient) Get(ctx context.Context, h http.Header, id string) (*corecloud.Subnet[corecloud.TCloudSubnetExtension],
	error) {

	resp := new(protocloud.SubnetGetResp[corecloud.TCloudSubnetExtension])
...
// BatchUpdate tencent cloud subnet.
func (v *SubnetClient) BatchUpdate(ctx context.Context, h http.Header,
	req *protocloud.SubnetBatchUpdateReq[protocloud.TCloudSubnetUpdateExt]) error {
...
func (v *SubnetClient) ListSubnetExt(ctx context.Context, h http.Header, req *core.ListReq) (
	*protocloud.SubnetExtListResult[corecloud.TCloudSubnetExtension], error) {

	resp := new(protocloud.SubnetExtListResp[corecloud.TCloudSubnetExtension])
