...
// Get huawei vpc.
func (v *VpcClient) Get(ctx context.Context, h http.Header, id string) (*corecloud.Vpc[corecloud.HuaWeiVpcExtension],
	error) {

	resp := new(protocloud.VpcGetResp[corecloud.HuaWeiVpcExtension])
...
// BatchUpdate huawei vpc.
func (v *VpcClient) BatchUpdate(ctx context.Context, h http.Header,
	req *protocloud.VpcBatchUpdateReq[protocloud.HuaWeiVpcUpdateExt]) error {
...
func (v *VpcClient) ListVpcExt(ctx context.Context, h http.Header, req *core.ListReq) (
	*protocloud.VpcExtListResult[corecloud.HuaWeiVpcExtension], error) {
	...
	resp := new(protocloud.VpcExtListResp[corecloud.HuaWeiVpcExtension])
