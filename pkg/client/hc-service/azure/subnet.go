...
func (s *SubnetClient) Create(ctx context.Context, h http.Header,
	req *proto.SubnetCreateReq[proto.AzureSubnetCreateExt]) (*core.CreateResult, error) {
...
func (s *SubnetClient) ListCountIP(ctx context.Context, h http.Header, req *proto.ListAzureCountIPReq) (
