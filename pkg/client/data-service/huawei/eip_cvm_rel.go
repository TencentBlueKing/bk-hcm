...
) ([]*datarelproto.EipExtWithCvmID[dataproto.HuaWeiEipExtensionResult], error) {
	resp := new(datarelproto.EipCvmRelWithEipExtListResp[dataproto.HuaWeiEipExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
