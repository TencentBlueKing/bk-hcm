...
func NewBatchCreateCvmPollerOption() *PollUntilDoneOption {
	return &PollUntilDoneOption{
...
func NewBatchCreateVpcPollerOption() *PollUntilDoneOption {
	return &PollUntilDoneOption{
		TimeoutTimeSecond: 30 * 60,
		Retry:             retry.NewRetryPolicy(10, [2]uint{2000, 30000}),
	}
...
func NewBatchCreateSubnetPollerOption() *PollUntilDoneOption {
	return &PollUntilDoneOption{
		TimeoutTimeSecond: 30 * 60,
		Retry:             retry.NewRetryPolicy(10, [2]uint{2000, 30000}),
	}
...
func NewBatchOperateCvmPollerOpt() *PollUntilDoneOption {
	return &PollUntilDoneOption{
