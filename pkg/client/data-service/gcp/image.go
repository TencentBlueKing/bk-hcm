...
func (rc *restClient) BatchCreateImage(ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchCreateReq[dataproto.GcpImageExtensionCreateReq],
...
func (rc *restClient) RetrieveImage(
	...
	h http.Header,
	imageID string,
) (*dataproto.ImageExtResult[dataproto.GcpImageExtensionResult], error) {
	resp := new(dataproto.ImageExtRetrieveResp[dataproto.GcpImageExtensionResult])
...
) (*dataproto.ImageExtListResult[dataproto.GcpImageExtensionResult], error) {
	resp := new(dataproto.ImageExtListResp[dataproto.GcpImageExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
...
func (rc *restClient) BatchUpdateImage(
	ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchUpdateReq[dataproto.GcpImageExtensionUpdateReq],
) (interface{}, error) {
