...
// CreateITSMTicket ...
func (a *ApplicationOfCreateAzureDisk) CreateITSMTicket(serviceID int64, callbackUrl string) (string, error) {
	// 渲染ITSM表单内容
...
func (a *ApplicationOfCreateAzureDisk) renderITSMForm() (string, error) {
	req := a.req
