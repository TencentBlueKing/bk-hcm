...
func (b *BillClient) ListBillItem(kt *kit.Kit, req *core.ListReq) (*billproto.TCloudBillItemListResult, error) {

	return common.Request[core.ListReq, billproto.TCloudBillItemListResult](
