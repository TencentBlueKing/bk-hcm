...
// List list bill.
func (v *BillClient) List(ctx context.Context, h http.Header, req *hcbillservice.TCloudBillListReq) (
	*hcbillservice.TCloudBillListResult, error) {

	resp := new(hcbillservice.TCloudBillListResp)
