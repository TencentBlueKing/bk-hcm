...
func (svc *service) SyncSubAccount(cts *rest.Contexts) (interface{}, error) {
	...
	if _, err = syncCli.SubAccount(cts.Kit, &huawei.SyncSubAccountOption{AccountID: req.AccountID}); err != nil {
		logs.Errorf("sync huawei sub account failed, err: %v, rid: %s", err, cts.Kit.Rid)
		return nil, err
	}
