...
// ListTCloudAuthPolicyReq define list auth policy request.
type ListTCloudAuthPolicyReq struct {
...
// Validate define list auth policy request.
func (req ListTCloudAuthPolicyReq) Validate() error {
