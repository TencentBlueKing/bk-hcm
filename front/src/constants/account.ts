...
export const DESC_ACCOUNT = {
  tcloud: {
    ...
    accountInfo: '主账号ID，子账号ID如何查看？登陆控制台，鼠标停留在右上角的账号图标上。第一行个人账号@后的数字为主账号ID。第二行账号ID后的数字为子账号ID',
    apiSecret: '在腾讯云控制台-访问管理-访问密钥-API密钥管理中查看 <a target="_blank" href="https://console.cloud.tencent.com/cam/capi">https://console.cloud.tencent.com/cam/capi</a>' },
  aws: { vendor: '亚马逊云支持中国站(<a target="_blank" href="http://amazonaws.cn">amazonaws.cn</a>)和国际站(<a target="_blank" href="http://aws.amazon.com">aws.amazon.com</a>)',
    accountInfo: '账号ID和IAM用户如何查看？进入AWS控制台，点击右上角用户名，可见“账户ID”和“IAM用户名称”',
    apiSecret: '进入AWS控制台，点击右上角用户名，点击“安全凭证”（<a target="_blank" href="https://us-east-1.console.aws.amazon.com/iam/home?region=ap-northeast-1#/security_credentials">https://us-east-1.console.aws.amazon.com/iam/home?region=ap-northeast-1#/security_credentials</a>）在“访问密钥”栏下可查看访问密钥ID。' },
  azure: { vendor: '微软云支持中国站(<a target="_blank" href="http://azure.cn">azure.cn</a>)和国际站(<a target="_blank" href="http://azure.microsoft.com">azure.microsoft.com</a>)',
    accountInfo: '租户ID，在Azure portal里的“Azure Active Directory”里查看，链接：<a target="_blank" href="https://portal.azure.com/#view/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/~/Overview">portal.azure.com/#view/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/~/Overview</a>'
