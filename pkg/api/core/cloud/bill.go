...
// AccountBillConfig defines account bill config info.
type AccountBillConfig[T AccountBillConfigExtension] struct {
	BaseAccountBillConfig `json:",inline"`
	Extension             *T `json:"extension"`
}

// BaseAccountBillConfig define account bill config.
type BaseAccountBillConfig struct {
	ID                string          `json:"id"`
...
// AccountBillConfigExtension defines account bill config extensional info.
