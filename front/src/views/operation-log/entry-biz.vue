...
const searchFields = computed(() =>
  conditionProperties.value.filter((field) => !field.apiOnly && field.id !== 'bk_biz_id'),
);
const dataListColumns = computed(() => columnProperties.value.filter((field) => field.id !== 'bk_biz_id'));
