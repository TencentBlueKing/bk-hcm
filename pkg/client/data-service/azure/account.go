...
func (a *AccountClient) Create(ctx context.Context, h http.Header,
	request *protocloud.AccountCreateReq[protocloud.AzureAccountExtensionCreateReq]) (
...
func (a *AccountClient) Update(ctx context.Context, h http.Header, accountID uint64,
	request *protocloud.AccountUpdateReq[protocloud.AzureAccountExtensionUpdateReq]) (
	interface{}, error,
) {
...
func (a *AccountClient) Get(ctx context.Context, h http.Header, accountID string) (
	*protocloud.AccountGetResult[protocore.AzureAccountExtension], error,
	...
	resp := new(protocloud.AccountGetResp[protocore.AzureAccountExtension])
