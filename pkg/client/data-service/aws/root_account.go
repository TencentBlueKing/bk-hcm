...
func (a *RootAccountClient) Create(kt *kit.Kit,
	...
	*core.CreateResult, error,
	...
	return common.Request[dataproto.RootAccountCreateReq[dataproto.AwsRootAccountExtensionCreateReq], core.CreateResult](
...
func (a *RootAccountClient) Update(kt *kit.Kit, accountID string,
	...
	return common.Request[dataproto.RootAccountUpdateReq[dataproto.AwsRootAccountExtensionUpdateReq], interface{}](
