...
func (c *Layer4ListenerBindRSExecutor) createTaskDetailsGroupByTargetGroup(kt *kit.Kit, lbCloudID string, details []*layer4ListenerBindRSTaskDetail) (map[string][]*layer4ListenerBindRSTaskDetail, map[string]string, error) {
...
func (c *Layer4ListenerBindRSExecutor) updateTaskManagementAndDetails(kt *kit.Kit, flowIDs []string, taskID string) error {
