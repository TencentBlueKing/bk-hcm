...
// CreateITSMTicket ...
func (a *ApplicationOfCreateAwsDisk) CreateITSMTicket(serviceID int64, callbackUrl string) (string, error) {
	// 渲染ITSM表单内容
...
func (a *ApplicationOfCreateAwsDisk) renderITSMForm() (string, error) {
	req := a.req
