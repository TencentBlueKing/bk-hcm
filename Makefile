...
api: pre
	...
	@mkdir -p ${OUTPUT_DIR}/bk-hcm-authserver/support-files/bin/
	@cp -f docs/api-docs/auth-server/bin/auth-register.sh ${OUTPUT_DIR}/bk-hcm-authserver/support-files/bin/
