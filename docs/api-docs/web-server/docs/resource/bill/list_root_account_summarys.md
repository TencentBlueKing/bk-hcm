...
- 该接口提供版本：v1.6.0+。
- 该接口所需权限：账单查询权限。
- 该接口功能描述：获取当月一级账号账单汇总数据。

### URL

POST /api/v1/account/bills/root_account_summarys/list
    ...
    "details": [
      {
        ...
        "bk_biz_num": 1,
        "product_num": 2,
        "created_at": "2024-07-03 03:40:18.0",
        "updated_at": "2024-07-03 03:40:18.0"
      }
    ]
  }
}
