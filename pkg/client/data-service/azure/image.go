...
func (rc *restClient) BatchCreateImage(ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchCreateReq[dataproto.AzureImageExtensionCreateReq],
...
func (rc *restClient) RetrieveImage(
	...
	h http.Header,
	imageID string,
) (*dataproto.ImageExtResult[dataproto.AzureImageExtensionResult], error) {
	resp := new(dataproto.ImageExtRetrieveResp[dataproto.AzureImageExtensionResult])
...
) (*dataproto.ImageExtListResult[dataproto.AzureImageExtensionResult], error) {
	resp := new(dataproto.ImageExtListResp[dataproto.AzureImageExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
...
func (rc *restClient) BatchUpdateImage(
	ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchUpdateReq[dataproto.AzureImageExtensionUpdateReq],
) (interface{}, error) {
