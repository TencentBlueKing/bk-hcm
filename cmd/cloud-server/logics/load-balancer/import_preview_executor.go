...
const (
	...
	// Layer4ListenerRsWeight 监听器批量调整RS权重
	Layer4ListenerRsWeight = "layer4_listener_rs_weight"
	// Layer7ListenerRsWeight 监听器批量调整RS权重
	Layer7ListenerRsWeight = "layer7_listener_rs_weight"
)
