...
// NewExtMessage new ext message.
func NewExtMessage(object interface{}) (ExtMessage, error) {
	marshal, err := Marshal(object)
	if err != nil {
		return nil, err
	}
...
// UnmarshalObject sets *m to a copy of data.
func (m *ExtMessage) UnmarshalObject(data interface{}) error {
	if m == nil {
		return errors.New("json.ExtMessage: UnmarshalObject on nil pointer")
	}
