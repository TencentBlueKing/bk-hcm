...
func (svc *service) SyncSubAccount(cts *rest.Contexts) (interface{}, error) {
	...
	if _, err = syncCli.SubAccount(cts.Kit, &gcp.SyncSubAccountOption{AccountID: req.AccountID}); err != nil {
		logs.Errorf("sync gcp sub account failed, err: %v, rid: %s", err, cts.Kit.Rid)
		return nil, err
	}
