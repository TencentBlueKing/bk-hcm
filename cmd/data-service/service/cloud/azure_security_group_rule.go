...
func (svc *azureSGRuleSvc) BatchCreateAzureRule(cts *rest.Contexts) (interface{}, error) {
	...
	for _, rule := range req.Rules {
		rules = append(rules, &tablecloud.AzureSecurityGroupRuleTable{
			...
			CloudDestinationSecurityGroupIDs: convStringSlice(rule.CloudDestinationSecurityGroupIDs),
			...
			CloudSourceSecurityGroupIDs:      convStringSlice(rule.CloudSourceSecurityGroupIDs),
