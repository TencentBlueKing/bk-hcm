...
func (v *VpcClient) Create(ctx context.Context, h http.Header,
	req *hcservice.VpcCreateReq[hcservice.GcpVpcCreateExt]) (*core.CreateResult, error) {
...
func (v *VpcClient) SyncVpc(ctx context.Context, h http.Header, req *sync.GcpGlobalResSyncReq) error {
	resp := new(rest.BaseResp)
