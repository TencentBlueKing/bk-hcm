...
func (a *RootAccountClient) Create(kt *kit.Kit,
	...
	*core.CreateResult, error,
	...
	return common.Request[dataproto.RootAccountCreateReq[dataproto.HuaWeiRootAccountExtensionCreateReq], core.CreateResult](
...
func (a *RootAccountClient) Get(ctx context.Context, h http.Header, accountID string) (
	*dataproto.RootAccountGetResult[protocore.HuaWeiRootAccountExtension], error,
	...
	resp := new(dataproto.RootAccountGetResp[protocore.HuaWeiRootAccountExtension])
