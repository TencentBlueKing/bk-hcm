...
func (rc *restClient) BatchCreateEip(ctx context.Context,
	h http.Header,
	request *dataproto.EipExtBatchCreateReq[dataproto.GcpEipExtensionCreateReq],
...
func (rc *restClient) RetrieveEip(
	...
	h http.Header,
	eipID string,
) (*dataproto.EipExtResult[dataproto.GcpEipExtensionResult], error) {
	resp := new(dataproto.EipExtRetrieveResp[dataproto.GcpEipExtensionResult])
...
) (*dataproto.EipExtListResult[dataproto.GcpEipExtensionResult], error) {
	resp := new(dataproto.EipExtListResp[dataproto.GcpEipExtensionResult])
...
func (rc *restClient) BatchUpdateEip(
	ctx context.Context,
	h http.Header,
	request *dataproto.EipExtBatchUpdateReq[dataproto.GcpEipExtensionUpdateReq],
) (interface{}, error) {
