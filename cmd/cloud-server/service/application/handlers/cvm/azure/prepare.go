...
func (a *ApplicationOfCreateAzureCvm) PrepareReq() error {
	// 密码加密
...
func (a *ApplicationOfCreateAzureCvm) GenerateApplicationContent() interface{} {
	// 需要将Vendor也存储进去
	return &struct {
		*proto.AzureCvmCreateReq `json:",inline"`
		Vendor                   enumor.Vendor `json:"vendor"`
	}{
		AzureCvmCreateReq: a.req,
		Vendor:            a.Vendor(),
	}
}

// PrepareReqFromContent 预处理请求参数，对于申请内容来着DB，其实入库前是加密了的
func (a *ApplicationOfCreateAzureCvm) PrepareReqFromContent() error {
	// 解密密码
