...
func (a *ApplicationOfCreateTCloudDisk) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
	return a.GetItsmPlatformAndAccountApprover(kt, managers, a.req.AccountID)
}

// GetBkBizIDs 获取当前的业务IDs
func (a *ApplicationOfCreateTCloudDisk) GetBkBizIDs() []int64 {
