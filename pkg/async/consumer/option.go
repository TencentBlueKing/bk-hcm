...
type SchedulerOption struct {
	...
	ScheduledFlowFetcher uint `json:"scheduled_flow_fetcher" validate:"required"`
	CanceledFlowFetcher  uint `json:"canceled_flow_fetcher" validate:"required"`
}
...
type DispatcherOption struct {
	WatchIntervalSec   uint `json:"watch_interval_sec" validate:"required"`
	PendingFlowFetcher uint `json:"pending_flow_fetcher" validate:"required"`
}
