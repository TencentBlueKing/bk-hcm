...
// PrepareReq ...
func (a *ApplicationOfCreateGcpDisk) PrepareReq() error {
	return nil
}
...
func (a *ApplicationOfCreateGcpDisk) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
