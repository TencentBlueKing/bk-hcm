...
// ListAllRoute list aws route.
func (r *RouteTableClient) ListAllRoute(ctx context.Context, h http.Header, req *routetable.AwsRouteListReq) (
	*routetable.AwsRouteListResult, error) {
...
func (r *RouteTableClient) ListRouteTableWithExt(ctx context.Context, h http.Header, req *core.ListReq) (
	...
	resp := new(routetable.RouteTableListExtResp[corert.AwsRouteTableExtension])
