...
func (rc *restClient) BatchCreateImage(ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchCreateReq[dataproto.HuaWeiImageExtensionCreateReq],
...
func (rc *restClient) RetrieveImage(
	...
	h http.Header,
	imageID string,
) (*dataproto.ImageExtResult[dataproto.HuaWeiImageExtensionResult], error) {
	resp := new(dataproto.ImageExtRetrieveResp[dataproto.HuaWeiImageExtensionResult])
...
) (*dataproto.ImageExtListResult[dataproto.HuaWeiImageExtensionResult], error) {
	resp := new(dataproto.ImageExtListResp[dataproto.HuaWeiImageExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
...
func (rc *restClient) BatchUpdateImage(
	ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchUpdateReq[dataproto.HuaWeiImageExtensionUpdateReq],
) (interface{}, error) {
