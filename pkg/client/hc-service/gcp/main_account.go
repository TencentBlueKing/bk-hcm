...
func (m *MainAccountClient) Create(kt *kit.Kit,
	request *dataproto.CreateGcpMainAccountReq) (*dataproto.CreateGcpMainAccountResp, error) {

	return common.Request[dataproto.CreateGcpMainAccountReq, dataproto.CreateGcpMainAccountResp](
