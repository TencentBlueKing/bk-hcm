...
// ListSecurityGroupRuleCountReq define list security group rule count req.
...
// ListSecurityGroupRuleCountResp define list security group rule count resp.
type ListSecurityGroupRuleCountResp = map[string]int64
