...
func (v *VpcClient) BatchCreate(ctx context.Context, h http.Header,
	req *protocloud.VpcBatchCreateReq[corecloud.AzureVpcExtension]) (*core.BatchCreateResult, error) {
	...
	err := v.client.Post().
		WithContext(ctx).
		Body(req).
		SubResourcef("/vendors/%s/vpcs/batch/create", enumor.Azure).
		WithHeaders(h).
		Do().
		Into(resp)
	if err != nil {
...
func (v *VpcClient) Get(ctx context.Context, h http.Header, id string) (*corecloud.Vpc[corecloud.AzureVpcExtension],
	...
	err := v.client.Get().
		WithContext(ctx).
		SubResourcef("/vendors/%s/vpcs/%s", enumor.Azure, id).
		WithHeaders(h).
		Do().
		Into(resp)
	if err != nil {
...
func (v *VpcClient) BatchUpdate(ctx context.Context, h http.Header,
	...
	err := v.client.Patch().
		WithContext(ctx).
		Body(req).
		SubResourcef("/vendors/%s/vpcs/batch", enumor.Azure).
		WithHeaders(h).
		Do().
		Into(resp)
	if err != nil {
