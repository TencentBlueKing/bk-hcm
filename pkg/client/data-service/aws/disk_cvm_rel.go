...
) ([]*datarelproto.DiskExtWithCvmID[dataproto.AwsDiskExtensionResult], error) {
	resp := new(datarelproto.DiskCvmRelWithDiskExtListResp[dataproto.AwsDiskExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
