...
func (cli *CvmClient) SyncCvmWithRelResource(ctx context.Context, h http.Header, request *sync.HuaWeiSyncReq) error {
...
// BatchCreateCvm ....
func (cli *CvmClient) BatchCreateCvm(ctx context.Context, h http.Header, request *protocvm.HuaWeiBatchCreateReq) (
...
// InquiryPrice ....
func (cli *CvmClient) InquiryPrice(kt *kit.Kit, request *protocvm.HuaWeiBatchCreateReq) (
