...
func (rc *restClient) BatchCreateImage(ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchCreateReq[dataproto.AwsImageExtensionCreateReq],
...
func (rc *restClient) RetrieveImage(
	...
	h http.Header,
	imageID string,
) (*dataproto.ImageExtResult[dataproto.AwsImageExtensionResult], error) {
	resp := new(dataproto.ImageExtRetrieveResp[dataproto.AwsImageExtensionResult])
...
) (*dataproto.ImageExtListResult[dataproto.AwsImageExtensionResult], error) {
	resp := new(dataproto.ImageExtListResp[dataproto.AwsImageExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
...
func (rc *restClient) BatchUpdateImage(
	ctx context.Context,
	h http.Header,
	request *dataproto.ImageExtBatchUpdateReq[dataproto.AwsImageExtensionUpdateReq],
) (interface{}, error) {
