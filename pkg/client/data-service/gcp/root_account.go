...
func (a *RootAccountClient) Create(kt *kit.Kit,
	request *dataproto.RootAccountCreateReq[dataproto.GcpRootAccountExtensionCreateReq]) (
	*core.CreateResult, error,
) {

	return common.Request[dataproto.RootAccountCreateReq[dataproto.GcpRootAccountExtensionCreateReq], core.CreateResult](
		a.client, rest.POST, kt, request, "/root_accounts/create")
}

// Get gcp account detail.
func (a *RootAccountClient) Get(kt *kit.Kit, accountID string) (
	*dataproto.RootAccountGetResult[protocore.GcpRootAccountExtension], error,
) {

	return common.Request[common.Empty, dataproto.RootAccountGetResult[protocore.GcpRootAccountExtension]](
		a.client, rest.GET, kt, nil, "/root_accounts/%s", accountID)
}

// Update ...
func (a *RootAccountClient) Update(kt *kit.Kit, accountID string,
	request *dataproto.RootAccountUpdateReq[dataproto.GcpRootAccountExtensionUpdateReq]) (
	interface{}, error,
) {

	return common.Request[dataproto.RootAccountUpdateReq[dataproto.GcpRootAccountExtensionUpdateReq], interface{}](
