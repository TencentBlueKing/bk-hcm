...
POST /api/v1/cloud/vendors/aws/assume_role/sagemaker/clusters/list
    ...
    "ClusterSummaries": [
      {
        ...
        "ClusterArn": "arn:aws:sagemaker:us-west-2:123456789012:cluster/demo",
...
| code | int | 状态码 |
| message | string | 请求信息 |
| data | object | AWS SageMaker `ListClusters` 原始响应透传 |
