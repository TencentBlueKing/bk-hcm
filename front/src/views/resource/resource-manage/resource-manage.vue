        ...
        <template v-for="item in tabs" :key="item.name">
          <bk-tab-panel
            ...
            v-if="
              item.name !== 'certs' ||
                (item.name === 'certs' &&
                  ((!resourceAccountStore.resourceAccount.vendor && !resourceAccountStore.currentVendor) ||
                    (!route.query.accountId && resourceAccountStore.currentVendor === VendorEnum.TCLOUD) ||
