...
// SyncDisk sync disk.
func (cli *DiskClient) SyncDisk(ctx context.Context, h http.Header, request *sync.TCloudSyncReq) error {
...
// AttachDisk ...
func (cli *DiskClient) AttachDisk(ctx context.Context, h http.Header, req *disk.TCloudDiskAttachReq) error {
