...
func (cli *SubAccountClient) Get(kt *kit.Kit, id string) (
	*coresubaccount.SubAccount[coresubaccount.AwsExtension], error) {
	...
	resp := &struct {
		...
		Data          *coresubaccount.SubAccount[coresubaccount.AwsExtension] `json:"data"`
	}{}
...
func (cli *SubAccountClient) ListExt(ctx context.Context, h http.Header, request *core.ListReq) (
	*dssubaccount.ListExtResult[coresubaccount.AwsExtension], error) {

	resp := &struct {
		rest.BaseResp `json:",inline"`
		Data          *dssubaccount.ListExtResult[coresubaccount.AwsExtension] `json:"data"`
	}{}
