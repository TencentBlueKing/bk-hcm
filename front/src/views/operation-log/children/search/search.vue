...
import type { ISearchCondition } from '@/views/operation-log/typings';
...
const getSearchCompProps = (field: ModelPropertySearch) => {
  ...
  if (field.id === 'detail.data.res_flow.flow_id') {
    return {
      multiple: false,
      option: field.option,
      allowEmptyValues: [''],
...
<template>
  <div class="search">
    <grid-container layout="vertical" :column="4" :content-min-width="280" :gap="[16, 60]">
