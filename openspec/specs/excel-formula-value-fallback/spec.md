# excel-formula-value-fallback

## Purpose

Defines the fallback behavior for formula columns with missing cached values in Excel parsing: validate formula correctness then compute via CalcCellValue.
