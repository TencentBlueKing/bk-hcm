...
// SyncDisk sync disk.
func (cli *DiskClient) SyncDisk(ctx context.Context, h http.Header, request *sync.HuaWeiSyncReq) error {
...
// AttachDisk ...
func (cli *DiskClient) AttachDisk(ctx context.Context, h http.Header, req *disk.HuaWeiDiskAttachReq) error {
