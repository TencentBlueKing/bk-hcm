...
// BatchCreate batch create azure route table.
func (r *RouteTableClient) BatchCreate(ctx context.Context, h http.Header,
	req *routetable.RouteTableBatchCreateReq[routetable.AzureRouteTableCreateExt]) (*core.BatchCreateResult, error) {
...
// Get azure route table.
func (r *RouteTableClient) Get(ctx context.Context, h http.Header, id string) (
	*corert.RouteTable[corert.AzureRouteTableExtension], error) {

	resp := new(routetable.RouteTableGetResp[corert.AzureRouteTableExtension])
...
// BatchCreateRoute batch create azure route.
func (r *RouteTableClient) BatchCreateRoute(ctx context.Context, h http.Header, routeTableID string,
	req *routetable.AzureRouteBatchCreateReq) (*core.BatchCreateResult, error) {
...
// ListAllRoute list azure route.
func (r *RouteTableClient) ListAllRoute(ctx context.Context, h http.Header, req *routetable.AzureRouteListReq) (
	*routetable.AzureRouteListResult, error) {
...
// BatchDeleteRoute batch delete azure route.
...
func (r *RouteTableClient) ListRouteTableWithExt(ctx context.Context, h http.Header, req *core.ListReq) (
	...
	resp := new(routetable.RouteTableListExtResp[corert.AzureRouteTableExtension])
