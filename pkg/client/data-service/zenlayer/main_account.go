...
func (a *MainAccountClient) Create(kt *kit.Kit,
	request *dataproto.MainAccountCreateReq[dataproto.ZenlayerMainAccountExtensionCreateReq]) (
	*core.CreateResult, error,
) {

	return common.Request[dataproto.MainAccountCreateReq[dataproto.ZenlayerMainAccountExtensionCreateReq],
		core.CreateResult](a.client, rest.POST, kt, request, "/main_accounts/create")
}

// Get zenlayer account detail.
func (a *MainAccountClient) Get(kt *kit.Kit, accountID string) (
	*dataproto.MainAccountGetResult[protocore.ZenlayerMainAccountExtension], error,
) {

	return common.Request[common.Empty, dataproto.MainAccountGetResult[protocore.ZenlayerMainAccountExtension]](
