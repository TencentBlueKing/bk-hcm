...
POST /api/v1/cloud/bizs/{bk_biz_id}/vendors/{vendor}/account_secrets/list
...
| type    | string | 密钥类型, 枚举值：resource(资源管理)、security(安全管理)  |
| status   | string | 密钥状态, 枚举值：normal(正常)、invalid(失效)         |
| creator  | string | 创建者                                      |
| reviser  | string | 更新者                                      |
