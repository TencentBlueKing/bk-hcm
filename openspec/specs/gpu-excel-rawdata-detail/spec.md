# gpu-excel-rawdata-detail

## Purpose

Defines the detail response format using name + raw_data structure for GPU demand Excel import preview, replacing structured fields with a generic raw data array.
