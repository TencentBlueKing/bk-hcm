...
func (a *MainAccountClient) Create(kt *kit.Kit,
	request *dataproto.MainAccountCreateReq[dataproto.AzureMainAccountExtensionCreateReq]) (
	*core.CreateResult, error,
) {

	return common.Request[dataproto.MainAccountCreateReq[dataproto.AzureMainAccountExtensionCreateReq], core.CreateResult](
...
func (a *MainAccountClient) Get(kt *kit.Kit, accountID string) (
	*dataproto.MainAccountGetResult[protocore.AzureMainAccountExtension], error,
) {

	return common.Request[common.Empty, dataproto.MainAccountGetResult[protocore.AzureMainAccountExtension]](
