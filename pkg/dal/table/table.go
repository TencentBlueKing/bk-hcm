...
// Key是表名，Value是该表是否需要支持多租户
var TableMap = map[Name]bool{
	AuditTable:                   true,
	AccountTable:                 true,
	SubAccountTable:              false,
	AccountBizRelTable:           false,
	VpcTable:                     true,
	SubnetTable:                  true,
	IDGenerator:                  false,
	SecurityGroupTable:           true,
	VpcSecurityGroupRelTable:     false,
	SecurityGroupTagTable:        false,
	SecurityGroupSubnetTable:     false,
	SGSecurityGroupRuleTable:     false,
	TCloudSecurityGroupRuleTable: false,
	AwsSecurityGroupRuleTable:    false,
	HuaWeiSecurityGroupRuleTable: true,
	AzureSecurityGroupRuleTable:  false,
	SGNetworkInterfaceRelTable:   false,
	GcpFirewallRuleTable:         true,
	HuaWeiRegionTable:            true,
	AzureRGTable:                 true,
	AzureRegionTable:             true,
	GcpRegionTable:               true,
	AwsRegionTable:               false,
	...
	ApprovalProcessTable:         true,
	NetworkInterfaceTable:        true,
	NetworkInterfaceCvmRelTable:  false,
	RecycleRecordTable:           true,
	EipTable:                     true,
	DiskTable:                    true,
	ImageTable:                   true,
	DiskCvmRelTableName:          false,
	EipCvmRelTableName:           false,
	AccountBillConfigTable:       false,
	UserCollectionTable:          true,
	AccountSyncDetailTable:       false,
	CloudSelectionSchemeTable:    true,
	CloudSelectionBizTypeTable:   true,
	CloudSelectionIdcTable:       true,
	SslCertTable:                 true,

	// TODO: 临时方案
	RecycleRecordTableTaskID: false,

	AsyncFlowTable:     false,
	AsyncFlowTaskTable: false,

	ArgumentTemplateTable: true,

	AccountBillMonthTaskTable:       false,
	AccountBillDailyPullTaskTable:   false,
	AccountBillSummaryMainTable:     false,
	AccountBillSummaryVersionTable:  false,
	AccountBillSummaryDailyTable:    false,
	AccountBillItemTable:            false,
	AccountBillAdjustmentItemTable:  false,
	AccountBillSummaryRootTable:     false,
	RootAccountBillConfigTable:      true,
	AccountBillExchangeRateTable:    true,
	AccountBillSyncRecordTable:      true,
	LoadBalancerTable:               true,
	SecurityGroupCommonRelTable:     false,
	LoadBalancerListenerTable:       false,
	TCloudLbUrlRuleTable:            false,
	LoadBalancerTargetTable:         false,
	LoadBalancerTargetGroupTable:    false,
	TargetGroupListenerRuleRelTable: false,
	ResourceFlowRelTable:            false,
	ResourceFlowLockTable:           false,

	MainAccountTable: true,
	RootAccountTable: true,

	TaskManagementTable: false,
	TaskDetailTable:     false,

	GlobalConfigTable: false,
}
