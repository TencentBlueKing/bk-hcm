...
// RouteTableClient is hc service azure route table api client.
...
func (r *RouteTableClient) SyncRouteTable(ctx context.Context, h http.Header, req *sync.AzureSyncReq) error {
