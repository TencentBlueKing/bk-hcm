...
func (a *ApplicationOfCreateAzureVpc) PrepareReq() error {
...
func (a *ApplicationOfCreateAzureVpc) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
