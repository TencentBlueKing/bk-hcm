...
func (rc *restClient) BatchCreateDisk(ctx context.Context,
	h http.Header,
	request *dataproto.DiskExtBatchCreateReq[dataproto.TCloudDiskExtensionCreateReq],
...
func (rc *restClient) RetrieveDisk(
	...
	h http.Header,
	diskID string,
) (*dataproto.DiskExtResult[dataproto.TCloudDiskExtensionResult], error) {
	resp := new(dataproto.DiskExtRetrieveResp[dataproto.TCloudDiskExtensionResult])
...
) (*dataproto.DiskExtListResult[dataproto.TCloudDiskExtensionResult], error) {
	resp := new(dataproto.DiskExtListResp[dataproto.TCloudDiskExtensionResult])
...
func (rc *restClient) BatchUpdateDisk(
	ctx context.Context,
	h http.Header,
	request *dataproto.DiskExtBatchUpdateReq[dataproto.TCloudDiskExtensionUpdateReq],
) (interface{}, error) {
