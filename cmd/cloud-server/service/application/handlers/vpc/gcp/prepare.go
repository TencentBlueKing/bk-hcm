...
func (a *ApplicationOfCreateGcpVpc) PrepareReq() error {

	return nil
}

// GenerateApplicationContent 获取预处理过的数据，以interface格式
func (a *ApplicationOfCreateGcpVpc) GenerateApplicationContent() interface{} {
	// 需要将Vendor也存储进去
	return &struct {
		*csvpc.GcpVpcCreateReq `json:",inline"`
		Vendor                 enumor.Vendor `json:"vendor"`
	}{
		GcpVpcCreateReq: a.req,
		Vendor:          a.Vendor(),
	}
}

// PrepareReqFromContent 预处理请求参数，对于申请内容来着DB，其实入库前是加密了的
func (a *ApplicationOfCreateGcpVpc) PrepareReqFromContent() error {

	return nil
}

// GetItsmApprover 获取itsm审批人
func (a *ApplicationOfCreateGcpVpc) GetItsmApprover(kt *kit.Kit, managers []string) ([]itsm.VariableApprover, error) {
