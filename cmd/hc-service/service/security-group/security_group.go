...
func InitSecurityGroupService(cap *capability.Capability) {
	...
	h.Add("TCloudSGBatchAssociateCloudCvm", "POST",
		"/vendors/tcloud/security_groups/associate/cloud_cvms/batch", sg.TCloudSGBatchAssociateCloudCvm)
	h.Add("TCloudSGBatchDisassociateCloudCvm", "POST",
		"/vendors/tcloud/security_groups/disassociate/cloud_cvms/batch", sg.TCloudSGBatchDisassociateCloudCvm)
