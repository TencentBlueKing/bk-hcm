...
func (rc *restClient) BatchCreateDisk(ctx context.Context,
	h http.Header,
	request *dataproto.DiskExtBatchCreateReq[dataproto.GcpDiskExtensionCreateReq],
...
func (rc *restClient) RetrieveDisk(
	...
	h http.Header,
	diskID string,
) (*dataproto.DiskExtResult[dataproto.GcpDiskExtensionResult], error) {
	resp := new(dataproto.DiskExtRetrieveResp[dataproto.GcpDiskExtensionResult])
...
) (*dataproto.DiskExtListResult[dataproto.GcpDiskExtensionResult], error) {
	resp := new(dataproto.DiskExtListResp[dataproto.GcpDiskExtensionResult])
...
func (rc *restClient) BatchUpdateDisk(
	ctx context.Context,
	h http.Header,
	request *dataproto.DiskExtBatchUpadteReq[dataproto.GcpDiskExtensionUpdateReq],
) (interface{}, error) {
