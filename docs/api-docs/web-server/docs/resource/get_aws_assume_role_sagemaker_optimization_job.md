...
POST /api/v1/cloud/vendors/aws/assume_role/sagemaker/optimization_jobs/get
...
| optimization_job_name | string | 是 | Optimization Job 名称 |
...
```json
{
  ...
  "region": "us-east-1",
  "optimization_job_name": "demo-optimization-job"
}
```
...
```json
{
  "code": 0,
  "message": "",
  "data": {"OptimizationJobName":"demo-optimization-job","DeploymentInstanceType":"ml.g5.xlarge","MaxInstanceCount":1}
}
```
...
| code | int | 状态码 |
| message | string | 请求信息 |
| data | object | AWS SageMaker `DescribeOptimizationJob` 原始响应透传 |
