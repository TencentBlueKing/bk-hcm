# gpu-excel-fixed-field-extract

## Purpose

Defines how year and month values are extracted from Excel data rows into dedicated detail fields instead of the extension array.
