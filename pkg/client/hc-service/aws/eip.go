...
// AssociateEip ...
func (cli *EipClient) AssociateEip(ctx context.Context, h http.Header, req *eip.AwsEipAssociateReq) error {
	resp := new(rest.BaseResp)
...
// DisassociateEip ...
func (cli *EipClient) DisassociateEip(ctx context.Context, h http.Header, req *eip.AwsEipDisassociateReq) error {
	resp := new(rest.BaseResp)
