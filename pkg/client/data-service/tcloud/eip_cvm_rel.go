...
) ([]*datarelproto.EipExtWithCvmID[dataproto.TCloudEipExtensionResult], error) {
	resp := new(datarelproto.EipCvmRelWithEipExtListResp[dataproto.TCloudEipExtensionResult])
	err := rc.client.Post().
		WithContext(ctx).
		Body(request).
