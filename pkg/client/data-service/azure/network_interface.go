...
func (v *NetworkInterfaceClient) ListNetworkInterfaceExt(ctx context.Context, h http.Header, req *core.ListReq) (
	*datacloudniproto.NetworkInterfaceExtListResult[coreni.AzureNIExtension], error) {

	resp := new(datacloudniproto.NetworkInterfaceExtListResp[coreni.AzureNIExtension])
