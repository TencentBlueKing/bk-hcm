...
// ApplicationOfCreateTCloudLB ...
type ApplicationOfCreateTCloudLB struct {
	bizId int64
	handlers.BaseApplicationHandler
	req *hclb.TCloudLoadBalancerCreateReq
}

// NewApplicationOfCreateTCloudLB ...
func NewApplicationOfCreateTCloudLB(opt *handlers.HandlerOption,
